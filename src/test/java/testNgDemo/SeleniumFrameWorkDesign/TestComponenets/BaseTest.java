...
public class BaseTest {
	...
	public WebDriver initializeDriver() throws IOException {
		...
		FileInputStream fis = new FileInputStream(System.getProperty("user.dir")
				+ "\\src\\main\\java\\testNgDemo\\AbstarctPackage\\resources\\GobalData.properties");
		props.load(fis);
	...
	public List<HashMap<String, String>> getJsonDataToRead(String filePath) throws IOException {
